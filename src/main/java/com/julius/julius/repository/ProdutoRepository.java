...
public interface ProdutoRepository extends JpaRepository<Produto, Long> {
    ...
    Page<Produto> dsfindFirstByOrderByDataCadastroDes(@Param("site") Long site, Pageable pageable);
    ...
    Page<Produto> findAllIncludingSiteOneAndExcludingSiteTwo(@Param("site") Long site, Pageable pageable);
